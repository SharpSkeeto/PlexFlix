...
namespace MyPlexManager.ViewModels.Exclude;
...
// ***********************************************************************************************
// Original file from XAML Controls Gallery: https://github.com/microsoft/Xaml-Controls-Gallery/blob/winui3preview/XamlControlsGallery/CollectionsInterop.cs
// ***********************************************************************************************
public class ObservableCollection<T> : Collection<T>, INotifyCollectionChanged, INotifyPropertyChanged
{
	...
	event System.Collections.Specialized.NotifyCollectionChangedEventHandler? INotifyCollectionChanged.CollectionChanged
	{
		add
		{
	...
	protected virtual void OnCollectionChanged(
		...
		int oldIndex)
	{
		OnCollectionChanged(new NotifyCollectionChangedEventArgs((global::Windows.UI.Xaml.Interop.NotifyCollectionChangedAction)action, newItems, oldItems, newIndex, oldIndex));
	}
...
public class TestBindableVector<T> : IList<T>, IBindableVector
{
	...
	global::Windows.UI.Xaml.Interop.IBindableVectorView IBindableVector.GetView()
	{
		throw new NotImplementedException();
	}

	global::Windows.UI.Xaml.Interop.IBindableIterator IBindableIterable.First()
	{
		throw new NotImplementedException();
	}
}
